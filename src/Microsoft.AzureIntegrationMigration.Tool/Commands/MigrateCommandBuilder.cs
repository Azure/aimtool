...
{
    /// <summary>
    /// Defines the command line options for the migrate verb.
    /// </summary>
    public class MigrateCommandBuilder : ICommandBuilder
    {
        /// <summary>
        /// Defines the logger.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new instance of the <see cref="MigrateCommandBuilder"/> class with a logger.
        /// </summary>
        /// <param name="logger">The logger instance.</param>
        public MigrateCommandBuilder(ILogger<MigrateCommandBuilder> logger)
        {
        ...
        /// <summary>
        /// Build the command for the migrate verb.
        /// </summary>
